# Text analysis: task-by-task solutions
...
## Task 2. SMS classification

```python
model = train_text_classifier("2_sms.csv", "text", "label")
print(predict_with_confidence(model, "free prize click now"))
```
...
## Tasks 5-10. LDA, HH, Word2Vec, Text-to-SQL, headlines
